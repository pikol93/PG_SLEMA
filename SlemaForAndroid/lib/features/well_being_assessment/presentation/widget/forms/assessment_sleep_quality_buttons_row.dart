...
import 'package:pg_slema/features/well_being_assessment/presentation/widget/forms/assessment_sleep_quality_button.dart';
import 'package:pg_slema/features/well_being_assessment/presentation/widget/forms/sleep_quality.dart';
...
class AssessmentSleepQualityButtonsRow extends StatelessWidget with Logger {
  ...
  Widget build(BuildContext context) {
    var rowChildren = SleepQuality.values
        .map((sleepQuality) => AssessmentSleepQualityButton(
